function Login() {
  return (
    <div className="App-body flex flex-col p-5 pl-1 h-[45vh] border-t-4 border-main">
      ...
      <div className="text-lg flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-0">
        ...
        <input type="email" id="email" name="email" className="border rounded w-3/5 sm:w-auto px-2 py-1" />
        <label htmlFor="password" className="sm:pl-2 sm:pr-2">Password:</label>
        <input type="password" id="password" name="password" className="border rounded w-3/5 sm:w-auto px-2 py-1" />
